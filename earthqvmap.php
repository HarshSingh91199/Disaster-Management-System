...
<body id="LoginForm">
  ...
  <h3 align="left">Vulnerability Map</h3>
  <hr class="rounded">
  <h4><b>58.6 per cent of the landmass is prone to earthquakes of moderate to very high intensity.</b></h4>
<img src="eqvul.jpg" alt="Vulnerability Map" width="60%" height="100%" align="center">
<hr class="rounded">
